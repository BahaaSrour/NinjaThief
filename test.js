...
function preload (){
    ...
    this.load.spritesheet('shuriken', 'assets/shurikenWeapon.png', { frameWidth: 108, frameHeight: 73 });
}
...
shurikenfired = this.physics.add.sprite(200, 100, 'shuriken').setScale(0.5);
 //----------------------
 shurikenfired = this.physics.add.sprite(200, 100, 'shuriken').setScale(0.5);
 shurikenfired.setBounce(0.2);
 shurikenfired.setCollideWorldBounds(true);
 this.physics.add.collider(shurikenfired, platforms);
    ...
    game.anims.create({
        key: 'left',
        frames: this.anims.generateFrameNumbers('shuriken', {start: 0, end:5 }),
        frameRate: 10,
        repeat: -1
    });
...
function update (){
    ...
    if (cursors.left.isDown) {
        ...
        shurikenfired.setVelocityX(-1000);
        
        player.anims.play('left', true);
        shurikenfired.anims.play('a', true);
        ...
        shurikenfired.anims.play('d', true);
    }
    else {
